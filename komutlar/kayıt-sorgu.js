...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["776167070492131371" ].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setFooter(`Adox V2`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
