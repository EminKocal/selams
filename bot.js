...
client.on("guildMemberAdd", member => {
  member.roles.add('776166607570731028'); // UNREGİSTER ROLÜNÜN İDSİNİ GİRİN
});
...
client.on("userUpdate", async (stg, yeni) => {
  ...
  var tag = "𝔼go"; // Buraya Ekip Tag
  var tagrol = "776165735051296858"; // Buraya Ekip Rolünün ID
  var kanal = "776161492969979958"; // Loglanacağı Kanalın ID
